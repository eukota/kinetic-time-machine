export const About = () => (
  <div className="h-full overflow-y-auto bg-gray-950 text-white">
    <div className="max-w-2xl mx-auto px-6 py-12 space-y-8">
      ...
      <div>
        <h1 className="text-3xl font-bold mb-2">Kinetic Time Machine</h1>
        <p className="text-white/50 text-sm">A race-day photo tracker for the Kinetic Grand Championship</p>
      </div>
      ...
      <div className="border-t border-white/10 pt-8 flex flex-wrap gap-3">
        <a
